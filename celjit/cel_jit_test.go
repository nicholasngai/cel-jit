...
var tests = []struct {
	...
	{"AllError", "[1, 2, {}.error].all(x, x == 1)", nil, nil, nil, cel.BoolType},
	...
	{"ConditionalErrorFalse", "true ? {\"foobar\": 1}.error : 2", nil, nil, nil, cel.IntType},
	{"LogicalAnd", "true && false", nil, nil, nil, cel.BoolType},
	{"LogicalAndErrorTrue", "{}.error && true", nil, nil, nil, cel.BoolType},
	{"LogicalAndErrorFalse", "{}.error && false", nil, nil, nil, cel.BoolType},
	{"LogicalOr", "true || false", nil, nil, nil, cel.BoolType},
	{"LogicalOrErrorTrue", "{}.error || true", nil, nil, nil, cel.BoolType},
	{"LogicalOrErrorFalse", "{}.error || false", nil, nil, nil, cel.BoolType},
