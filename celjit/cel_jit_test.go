...
var tests = []struct {
	...
	{"InNumericDyn", "dyn(1) in [dyn(1.0), dyn(2.0), dyn(3.0)]", nil, nil, nil, cel.BoolType},
	{"InMap", "\"foo\" in {\"foo\": 1, \"bar\": 2}", nil, nil, nil, cel.BoolType},
	{"InMapNumeric", "dyn(1) in {1u: \"foo\", 2u: \"bar\"}", nil, nil, nil, cel.BoolType},
	{"InMapNumericDouble", "{1.0: \"foo\", 2.0: \"bar\"}[dyn(1)]", nil, nil, nil, cel.StringType},
	{"InMapNumericDyn", "dyn(1) in {dyn(1u): \"foo\", dyn(2u): \"bar\", dyn(3u): \"fizzbuzz\"}", nil, nil, nil, cel.BoolType},
