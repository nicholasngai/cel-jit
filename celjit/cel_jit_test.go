...
var tests = []struct{
	...
	{"IntFromInt", "int(1)", nil, nil},
	{"IntFromUint", "int(1u)", nil, nil},
	{"IntFromUintOutOfRange", "int(0xffffffffffffffffu)", nil, nil},
	{"IntFromDouble", "int(1.0)", nil, nil},
	{"IntFromDoubleHalf", "int(1.5)", nil, nil},
	{"IntFromDoubleOutOfRange1", "int(1e200)", nil, nil},
	{"IntFromDoubleOutOfRange2", "int(-1e200)", nil, nil},
	{"IntFromString", "int(\"1\")", nil, nil},
	{"IntFromStringInvalid", "int(\"foobar\")", nil, nil},
	{"IntFromTimestamp", "int(timestamp(\"2026-08-04T12:34:56Z\"))", nil, nil},
	{"UintFromUint", "uint(1u)", nil, nil},
	{"UintFromInt", "uint(1)", nil, nil},
	{"UintFromIntOutOfRange", "uint(-1)", nil, nil},
	{"UintFromDouble", "uint(1.0)", nil, nil},
	{"UintFromDoubleHalf", "uint(1.5)", nil, nil},
	{"UintFromDoubleOutOfRange1", "uint(-1.0)", nil, nil},
	{"UintFromDoubleOutOfRange2", "uint(1e200)", nil, nil},
	{"UintFromString", "uint(\"1\")", nil, nil},
	{"UintFromStringInvalid", "uint(\"foobar\")", nil, nil},
	{"DoubleFromDouble", "double(1.0)", nil, nil},
	{"DoubleFromInt", "double(1)", nil, nil},
	{"DoubleFromUint", "double(1u)", nil, nil},
	{"DoubleFromString", "double(\"1.0\")", nil, nil},
	{"DoubleFromStringInvalid", "double(\"foobar\")", nil, nil},
	{"BoolFromBool", "bool(true)", nil, nil},
	{"BoolFromString", "bool(\"true\")", nil, nil},
	{"BoolFromStringInvalid", "bool(\"foobar\")", nil, nil},
	{"StringFromString", "string(\"foobar\")", nil, nil},
	{"StringFromInt", "string(1)", nil, nil},
	{"StringFromUint", "string(1u)", nil, nil},
	{"StringFromFloat", "string(1.0)", nil, nil},
	{"StringFromBool", "string(true)", nil, nil},
	{"StringFromBytes", "string(b\"foobar\")", nil, nil},
	{"StringFromTimestamp", "string(timestamp(\"2026-08-04T12:34:56Z\"))", nil, nil},
	{"StringFromDuration", "string(duration(\"1h\"))", nil, nil},
	{"StringFromDurationFractional", "string(duration(\"60.1s\"))", nil, nil},
	{"BytesFromBytes", "bytes(b\"foobar\")", nil, nil},
	{"BytesFromString", "bytes(\"foobar\")", nil, nil},
	{"TimestampFromTimestamp", "timestamp(timestamp(\"2026-08-04T12:34:56Z\"))", nil, nil},
	{"TimestampFromString", "timestamp(\"2026-08-04T12:34:56Z\")", nil, nil},
	{"DurationFromDuration", "duration(duration(\"1s\"))", nil, nil},
	{"DurationFromString", "duration(\"1s\")", nil, nil},
	{"Dyn", "dyn(1)", nil, nil},
